...
/**
 * ResourceAuthorization for the `project-statuses` resource (spec 0023).
 *
 ...
 */
class ProjectStatusesAuthorization extends AbstractResourceAuthorization
{
    ...
    {
        return [
            'delete' => $model !== null && $actor->can('project-statuses.delete'),
            'export' => $actor->can('project-statuses.export'),
            'import' => $actor->can('project-statuses.import'),
        ];
    }
}
