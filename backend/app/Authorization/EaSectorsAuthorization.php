...
/**
 * ResourceAuthorization for the `ea-sectors` resource (spec 0018).
 *
 ...
 */
class EaSectorsAuthorization extends AbstractResourceAuthorization
{
    ...
    protected function fieldPermissionCeiling(User $actor, ?Model $model): array
    {
        ...
        return [
            ...
            'tag_ids' => $mayWrite ? FieldPermission::visibleEditable() : FieldPermission::visibleReadonly(),
        ];
    }
    ...
    {
        return [
            'delete' => $model !== null && $actor->can('ea-sectors.delete'),
            'export' => $actor->can('ea-sectors.export'),
            'import' => $actor->can('ea-sectors.import'),
        ];
    }
}
