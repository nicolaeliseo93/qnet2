 ...
 * `set` filter with a static options catalogue.
 */
final class OpportunityStatusColumnCatalog
{
    /**
    ...
    public static function columns(): array
    {
        return [
            [
                'id' => 'name',
                'label' => 'opportunityStatuses.columns.name',
                'type' => 'text',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'color',
                'label' => 'opportunityStatuses.columns.color',
                'type' => 'text',
                'visible' => true,
                'sortable' => false,
                'filterable' => false,
            ...
            [
                'id' => 'sort_order',
                'label' => 'opportunityStatuses.columns.sort_order',
                'type' => 'number',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'group',
                'label' => 'opportunityStatuses.columns.group',
                'type' => 'badge',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'created_at',
                'label' => 'opportunityStatuses.columns.created_at',
                'type' => 'datetime',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
    ...
    public static function actions(): array
    {
        return [
            ...
            [
                ...
                'type' => 'danger',
                'confirm' => true,
                'permission' => 'opportunity-statuses.delete',
            ],
            [
                'key' => 'activity',
                ...
                'type' => 'action',
                'confirm' => false,
                'permission' => 'opportunity-statuses.viewActivity',
            ],
        ];
    }
}
