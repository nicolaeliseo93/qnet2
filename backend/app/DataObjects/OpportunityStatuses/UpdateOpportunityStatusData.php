...
/**
 * Validated payload for a partial (PATCH) opportunity status update
 * (PUT/PATCH /api/opportunity-statuses/{opportunityStatus}, spec 0043).
 *
 * Declared DTO (no "magic flying array") so the UpdateOpportunityStatusRequest
 * -> OpportunityStatusService contract is explicit. `color`/`group` are
 ...
 */
final readonly class UpdateOpportunityStatusData
{
    ...
    /**
     * Build from the validated UpdateOpportunityStatusRequest payload.
     *
