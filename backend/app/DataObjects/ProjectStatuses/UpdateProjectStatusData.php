 ...
 * (PUT/PATCH /api/project-statuses/{projectStatus}, spec 0023).
 *
 * Declared DTO (no "magic flying array") so the UpdateProjectStatusRequest ->
 * ProjectStatusService contract is explicit. `color` is a legitimately
 ...
 */
final readonly class UpdateProjectStatusData
{
    ...
    /**
     * Build from the validated UpdateProjectStatusRequest payload.
     *
