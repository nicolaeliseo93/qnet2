...
/**
 * Validates the query for GET /api/roles/for-select (ADR 0011).
 *
 * Authorization is intentionally NOT handled here (it stays in the controller via
 * authorize('viewAny', Role::class)). Pagination bounds mirror
 * BaseApiController::validateRequest (offset >= 0, 1 <= limit <= MAX_LIMIT).
 */
class RoleForSelectRequest extends FormRequest
{
