...
/**
 * Validates the query for GET /api/sectors/for-select (ADR 0011,
 * spec 0020), mirroring SourceForSelectRequest.
 *
 * Authorization is intentionally NOT handled here (it stays in the controller
 * via authorize('viewAny', Sector::class)). Pagination bounds mirror
 * BaseApiController::validateRequest (offset >= 0, 1 <= limit <= MAX_LIMIT).
 */
class SectorForSelectRequest extends FormRequest
{
    public function authorize(): bool
    {
        // Authorization handled in the controller via the SectorPolicy.
        return true;
    }
