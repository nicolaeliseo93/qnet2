...
/**
 * Validates the payload for POST /api/project-statuses (spec 0023).
 *
 * Authorization is intentionally NOT handled here (it stays in the controller
 * via authorize('create', ProjectStatus::class)). EnforcesFieldPermissions
...
class StoreProjectStatusRequest extends FormRequest
{
     ...
     */
    public function toData(): CreateProjectStatusData
    {
        /** @var array<string, mixed> $validated */
        $validated = $this->validated();

        return CreateProjectStatusData::fromValidated($validated);
    }
}
