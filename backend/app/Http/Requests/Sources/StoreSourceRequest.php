...
/**
 * Validates the payload for POST /api/sources (spec 0018).
 *
 * Authorization is intentionally NOT handled here (it stays in the controller
 * via authorize('create', Source::class)). EnforcesFieldPermissions (spec
...
class StoreSourceRequest extends FormRequest
{
     ...
     */
    public function toData(): CreateSourceData
    {
        /** @var array<string, mixed> $validated */
        $validated = $this->validated();

        return CreateSourceData::fromValidated($validated);
    }
}
