...
// ---------------------------------------------------------------------------
// AC-031/AC-034 — GET /api/meta/leads: the 7 fields, permissions.fields shape
// ---------------------------------------------------------------------------
...
it('200: field catalogue matches LeadsAuthorization::fields(), in order (AC-031)', function () {
    ...
    expect($keys)->toBe([
        'referent_id', 'campaign_id', 'operational_site_id', 'source_id', 'operator_id', 'notes', 'is_converted',
    ]);
