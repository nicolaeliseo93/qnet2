...
it('200 with the catalogue for users and roles, keys matching each resolver\'s fields()', function () {
    ...
    // `registries`, spec 0021 `custom-fields`, spec 0023 `project-statuses`,
    // `projects` AND `campaigns`, spec 0024 `leads`, all in the same generic
    ...
    expect($resources->keys()->all())->toEqualCanonicalizing([
        ...
        'registries', 'project-statuses', 'projects', 'campaigns', 'leads',
    ]);
