...
it('200 with the catalogue for users and roles, keys matching each resolver\'s fields()', function () {
    ...
    // `sources`, `sectors` AND `company-sites`, spec 0019 `tags`, spec 0020 `registries`, all in
    ...
    expect($resources->keys()->all())->toEqualCanonicalizing([
        ...
        'referents', 'attributes', 'product-categories', 'products', 'sources', 'sectors', 'tags', 'registries',
    ]);
