...
/**
 * AC-019 — permission gating of the Referents page. The generic
 ...
 * `<Can>` around the table and mounting `<TableView domain="referents">` with
 * the right domain.
 */
...
describe('ReferentsPage — permission gating (AC-019)', () => {
  it('shows the forbidden fallback and does not mount the table without viewAny', () => {
    ...
    expect(
      screen.getByText("You don't have permission to view referents."),
    ).toBeInTheDocument()
