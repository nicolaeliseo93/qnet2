...
describe('buildCreatePayload', () => {
  it('builds the create payload with a root parent_id (null)', () => {
    const values: EaSectorFormValues = { name: 'Applications', parent_id: null }
  ...
  it('builds the create payload with a selected parent', () => {
    const values: EaSectorFormValues = { name: 'Applications', parent_id: 1 }
...
describe('buildUpdatePayload', () => {
  ...
  it('includes only the changed name', () => {
    const values: EaSectorFormValues = { name: 'Business Applications', parent_id: 1 }
  ...
  it('includes both fields when both changed', () => {
    const values: EaSectorFormValues = { name: 'Business Applications', parent_id: 2 }
