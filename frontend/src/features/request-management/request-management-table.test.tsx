 ...
 * wires ONLY the "Lavora" (`view`) row action through `useModuleOpener`
 ...
 * mirroring the other Sheet-based adapters' suites (e.g. `LeadsTable`).
 */
...
function panel(): RequestWorkPanelWithPermissions {
  return {
    ...
    workflow_statuses: [{ id: 100, name: 'Open', color: 'blue', system_key: 'open' }],
    product_lines: [],
