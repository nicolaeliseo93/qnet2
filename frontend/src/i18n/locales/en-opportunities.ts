  ...
  form: {
    ...
    sections: {
      ...
      classification: {
        ...
        description: 'Company, site, business function, product category and source.',
      },
      team: {
        title: 'Team',
    ...
    companySiteSearch: 'Search company sites…',
    companySiteRequired: 'Company site is required.',
    ...
    operationalSiteRequired: 'Operational site is required.',
    productCategory: 'Product category',
