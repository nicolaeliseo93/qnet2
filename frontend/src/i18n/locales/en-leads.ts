...
export const leads = {
  ...
  detail: {
    ...
    unknownRegistry: 'Unknown contact',
    importedData: {
      title: 'Imported data',
    },
  ...
  form: {
    ...
    sections: {
      contact: {
        ...
        description: 'The contact, the campaign that generated it and the lead status.',
      },
      details: {
        title: 'Details',
    ...
    registry: 'Contact',
    registrySearch: 'Search contacts…',
    registryRequired: 'Contact is required.',
    campaign: 'Campaign',
