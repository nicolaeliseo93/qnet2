...
export const activityLog = {
  ...
  fields: {
    ...
    company_id: 'Società',
    responsible_rda_id: 'Responsabile richieste acquisto',
    responsible_tickets_id: 'Responsabile ticket',
    responsible_validation_contracts_id: 'Responsabile validazione contratti',
    responsible_validation_contracts_two_id: 'Responsabile validazione contratti (2° livello)',
    proforma_progressive: 'Progressivo proforma',
    invoice_progressive: 'Progressivo fattura',
    quotation_layout_id: 'Layout preventivo',
    quotation_header_id: 'Intestazione preventivo',
    quotation_footer_id: 'Piè di pagina preventivo',
    alias: 'Alias',
    first_name: 'Nome',
    last_name: 'Cognome',
