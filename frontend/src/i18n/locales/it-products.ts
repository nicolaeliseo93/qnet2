...
export const productCategories = {
  ...
  subtitle: "Sfoglia e gestisci l'albero delle categorie prodotto.",
  forbidden: 'Non hai i permessi per visualizzare le categorie prodotto.',
  tree: {
    expand: 'Espandi {{name}}',
    collapse: 'Comprimi {{name}}',
    addChild: 'Aggiungi sottocategoria a {{name}}',
    edit: 'Modifica {{name}}',
    delete: 'Elimina {{name}}',
    deleteConfirmTitle: 'Eliminare la categoria?',
    deleteConfirmDescription:
      'Verrà eliminata definitivamente "{{name}}". Le categorie con figli o prodotti non possono essere eliminate.',
    deleting: 'Eliminazione…',
    loadError: "Impossibile caricare l'albero delle categorie. Riprova.",
    empty: 'Nessuna categoria prodotto ancora.',
  },
  form: {
