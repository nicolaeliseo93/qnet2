...
export const registries = {
  ...
  form: {
    ...
    eaSectorsPlaceholder: 'Select EA sectors…',
    eaSectorsSearch: 'Search EA sectors…',
    eaSectorsEmpty: 'No EA sectors found.',
    eaSectorsError: 'Unable to load EA sectors.',
    eaSectorsRemove: 'Remove EA sector',
    referents: 'Referents',
    ...
    managers: 'Managers',
    managersPlaceholder: 'Select managers…',
    managersSearch: 'Search managers…',
    ...
    sections: {
      ...
      relations: {
        title: 'Relations',
        description: 'Source, EA sectors, referents, managers and internal roles.',
      },
      business: {
